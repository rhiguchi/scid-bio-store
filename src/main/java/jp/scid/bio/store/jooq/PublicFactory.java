...
public class PublicFactory extends org.jooq.util.h2.H2Factory {
	...
	private static final long serialVersionUID = -1118028122;
	...
	private final void initDefaultSchema() {
		org.jooq.conf.SettingsTools.getRenderMapping(getSettings()).setDefaultSchema(jp.scid.bio.store.jooq.Public.PUBLIC.getName());
	}
}
